...
<h4>Impact</h4>
<p>
Upon pilot, it is expected that average door-to-treatment time will <strong>reduce significantly</strong>. The system is positioned not as "AI does diagnosis" but as a layer of standardised support inside the stroke imaging pathway — augmenting the clinician's read, not replacing it.
</p>
`,
...
`,
    ...
    links: [{ label: "Read Paper", url: "https://www.nature.com/articles/s41598-026-63140-8" }]
  },
...
`,
  ...
  "hokpa": {
    tag: "Medical Devices · Embedded AI",
    title: "HokPa Hip — Wearable Fall-Detection Device",
    meta: "Sazeh Teb Parla · Feb 2021",
    body: `
<img class="modal-hero-img" src="projects/img/hokpa-modal.png" alt="HokPa Hip — wearable AI airbag belt for hip fracture prevention" style="max-height: none; height: auto;" />
